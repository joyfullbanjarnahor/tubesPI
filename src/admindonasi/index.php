...
<head>
    ...
    <title>Alumni Berbagi Administrator</title>
    <!-- Favicon-->
...
<body class="theme-blue">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy;  2021 <a href="javascript:void(0);">Alumni Berbagi</a>
                </div>
            </div>
            <!-- #Footer -->
        </aside>
        ...
        <!--isi-->
                    ...
                    <?php 
                         ...
                         switch($_GET['halaman'])
                        {
                            ...
                            case 'penerima': include'completed.php'; break;

                            case 'daftar-donasi': include'userdonasi.php'; break;

                            case 'sendemail': include'../email.php'; break;
